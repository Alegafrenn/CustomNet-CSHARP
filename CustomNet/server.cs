...
namespace CustomNet
{
    public class CustomServer
    {
        ...
        private void NotAssignedEvent(int clientid) {}
        private void NotAssignedEvent(int clientid, Disconnected reason) {}
        private void NotAssignedEvent(int clientid, Packet.CustomPacket packet) {}
